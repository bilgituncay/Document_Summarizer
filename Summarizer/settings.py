...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-5sdn7^=9mmhky9a2-n=llu))!s(7x7r#q$(6!hpdt&x0$()x6q',
)
...
MAX_DOCUMENT_UPLOAD_SIZE = int(os.environ.get('MAX_DOCUMENT_UPLOAD_SIZE', 10 * 1024 * 1024))
...
# LLM API key for summarization/Q&A tasks
